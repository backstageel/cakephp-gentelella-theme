...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo __('Atentique-se para entrar no Sistema') ?></p>
...
<?php echo $this->fetch('content'); ?>
    ...
    if (isset($theme['login']['show_social']) && $theme['login']['show_social']) {
        ...
        <div class="social-auth-links text-center">
          <p>- <?php echo __('OU') ?> -</p>
          <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> <?php echo __('Entrar Via Facebook') ?></a>
          <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> <?php echo __('Entrar Via Google+') ?></a>
        </div>
        <?php
    }
    ?>
    ...
    if (isset($theme['login']['show_remember']) && $theme['login']['show_remember']) {
        ?>
        <a href="#"><?php echo __('Esqueci Minha Senha') ?></a><br>
        <?php
    }
